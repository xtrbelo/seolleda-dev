...
export default function AuditPage() {
  ...
  return <section className="stock-page audit-page"><div className="page-heading"><div><span className="eyebrow">Controle</span><h1>Auditoria</h1><p>Histórico das alterações administrativas de lojas e terminais.</p></div></div>
    ...
    {error && <p className="page-error" role="alert">{error}</p>}<p className="results-summary" role="status">{events.length} alteração(ões) carregada(s).</p>
